...
document.getElementById('calcstar').onclick = function(e){
  ...
  console.log(salary,hourly,oil,fee,insurance,service,dep,other)
  //把上面抓到的值去計算總時數存到 hr 內
  var hr = parseInt((salary+oil+fee+insurance+service+dep+other)/hourly);
